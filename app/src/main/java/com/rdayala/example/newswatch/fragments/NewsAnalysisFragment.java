...
public class NewsAnalysisFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String TAG = "NewsAnalysisFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pbar = (ProgressBar)view.findViewById(R.id.analysis_progressbar);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.news_analysis_rv);
        connectionStatusText = (TextView)view.findViewById(R.id.analysis_connection_status);
    ...
    public void updateData() {
        ...
        if(savedValue == null || mItems == null || mDoRefresh) {
            ...
            RealmResults<FavoriteNewsItem> results = realm.where(FavoriteNewsItem.class).equalTo("mCategory", "NewsAnalysis").findAll();
        ...
        mAdapter.setDefaultTag("NewsAnalysis");
        if (mDoRefresh) {
    ...
    public void loadAnalysisNewsFeeds() {
                ...
                public void onResponse(Call<Feed> call, Response<Feed> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (FeedItem item : respFeed.getmChannel().getFeedItems()) {
                            ...
                            FavoriteNewsItem favoriteNewsItem = Feed2DBConversion.convertFeedToDBModelObject(item, "NewsAnalysis");
