...
public class TopNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String TAG = "TopNewsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pbar = (ProgressBar)view.findViewById(R.id.currentaffairs_progressbar);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.top_news_rv);
        connectionStatusText = (TextView)view.findViewById(R.id.currentaffairs_connection_status);
        ...
        if (savedInstanceState != null) {
            savedValue = savedInstanceState.getString("currentaffairsNewsState");
            mItems = savedInstanceState.getParcelableArrayList("currentaffairsNews");
        }
...
//    }
    ...
    public void onSaveInstanceState(Bundle state) {
        ...
        if (mItems != null) {
            state.putSerializable("currentaffairsNewsState", "yes");
            state.putParcelableArrayList("currentaffairsNews", new ArrayList<>(mItems));
        }
    ...
    public void updateData() {
        ...
        if (savedValue == null || mItems == null || mDoRefresh) {
            ...
            RealmResults<FavoriteNewsItem> results = realm.where(FavoriteNewsItem.class).equalTo("mCategory", "CurrentAffairs").findAll();
            results = results.sort("mDateAdded", Sort.DESCENDING);
            Log.d("TopNewsInspect ", String.valueOf(results.size()));
        ...
        mAdapter.setDefaultTag("CurrentAffairs");
        if (mDoRefresh) {
    ...
    public void loadCurrentAffairsNewsFeeds() {
            ...
            call.enqueue(new Callback<Feed>() {
                ...
                public void onResponse(Call<Feed> call, Response<Feed> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Log.d("TopNewsInspect ", String.valueOf(respFeed.getmChannel().getFeedItems().size()));

                        for (FeedItem item : respFeed.getmChannel().getFeedItems()) {

                            FavoriteNewsItem favoriteNewsItem = Feed2DBConversion.convertFeedToDBModelObject(item, "CurrentAffairs");
