...
public class SportsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pbar = (ProgressBar)view.findViewById(R.id.sports_progressbar);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.sports_news_rv);
        connectionStatusText = (TextView)view.findViewById(R.id.sports_connection_status);
...
//    }
    ...
    public void updateData() {
        ...
        if(savedValue == null || mItems == null || mDoRefresh) {
            ...
            RealmResults<FavoriteNewsItem> results = realm.where(FavoriteNewsItem.class).equalTo("mCategory", "Sports").findAll();
    ...
    public void loadSportsNewsFeeds() {
        ...
        if(isConnectedToInternet) {
            ...
            Call<Feed> call = service.getItems("dnaindia/KOmw"); // thehindu/UxDC
                ...
                public void onResponse(Call<Feed> call, Response<Feed> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (FeedItem item : respFeed.getmChannel().getFeedItems()) {
                            ...
                            FavoriteNewsItem favoriteNewsItem = Feed2DBConversion.convertFeedToDBModelObject(item, "Sports");
