...
public class SportsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("SportsNews", "onCreateView called!!");

        mRecyclerView = (RecyclerView)view.findViewById(R.id.sports_news_rv);
        ...
        if(savedInstanceState != null) {
            savedValue = savedInstanceState.getString("sportsNewsState");
            mItems = savedInstanceState.getParcelableArrayList("sportsNews");
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.d("SportsNews", "onActivityCreated called!");
    ...
    public void onSaveInstanceState(Bundle state) {
        ...
        Log.d("SportsNews", "onSaveInstanceState called!");
        if(mItems != null) {
            state.putSerializable("sportsNewsState", "yes");
            state.putParcelableArrayList("sportsNews", new ArrayList<>(mItems));
        }
    ...
    public void onResume() {
        ...
        if(savedValue != null) {
            Log.d("SportsNews", "onResume saved state is available!!");
            updateData();
        }
    }
    ...
    public void updateData() {
        ...
        mAdapter.setFeedTag("Sports");
        mRecyclerView.setAdapter(mAdapter);
    }

    public void loadSportsNewsFeeds() {
        ...
        Call<Feed> call = service.getItems("thehindu/UxDC");
        // Call<Feed> call = service.getItems("jagran/hOCS");
            ...
            public void onResponse(Call<Feed> call, Response<Feed> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    for(FeedItem item : mItems) {
                        Log.d("SportsNews - Item : " , item.getMtitle() + ", Link: " + item.getMlink());
                    }

                }
                else
                {
                    Log.e("SportsNews : " , "Request failed - Cannot request GitHub repositories");
                }
            }

            @Override
            public void onFailure(Call<Feed> call, Throwable t) {
                Log.e("SportsNews : ", "Error fetching repos : " + t.getMessage());
            }
        });
