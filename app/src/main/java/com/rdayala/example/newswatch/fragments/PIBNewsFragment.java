...
public class PIBNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String TAG = "PIBNewsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pbar = (ProgressBar)view.findViewById(R.id.pib_progressbar);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.pib_news_rv);
        connectionStatusText = (TextView)view.findViewById(R.id.pib_connection_status);
    ...
    public void updateData() {
        ...
        if(savedValue == null || mItems == null || mDoRefresh) {
            ...
            RealmResults<FavoriteNewsItem> results = realm.where(FavoriteNewsItem.class).equalTo("mCategory", "PIBNews").findAll();
        ...
        mAdapter.setDefaultTag("PIBNews");
        if (mDoRefresh) {
