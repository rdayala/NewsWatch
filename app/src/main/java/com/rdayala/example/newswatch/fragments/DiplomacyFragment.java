...
public class DiplomacyFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String TAG = "DiplomacyFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pbar = (ProgressBar)view.findViewById(R.id.diplomacy_progressbar);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.diplomacy_news_rv);
        connectionStatusText = (TextView)view.findViewById(R.id.diplomacy_connection_status);
    ...
    public void updateData() {
        ...
        if(savedValue == null || mItems == null || mDoRefresh) {
            ...
            RealmResults<FavoriteNewsItem> results = realm.where(FavoriteNewsItem.class).equalTo("mCategory", "Diplomacy").findAll();
        ...
        mAdapter.setDefaultTag("Diplomacy");
        if (mDoRefresh) {
                ...
                public void onResponse(Call<Feed> call, Response<Feed> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (FeedItem item : respFeed.getmChannel().getFeedItems()) {
                            ...
                            FavoriteNewsItem favoriteNewsItem = Feed2DBConversion.convertFeedToDBModelObject(item, "Diplomacy");
