...
public class EditorialsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pbar = (ProgressBar)view.findViewById(R.id.editorials_progressbar);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.editorials_news_rv);
        connectionStatusText = (TextView)view.findViewById(R.id.editorials_connection_status);
        ...
        if(savedInstanceState != null) {
            savedValue = savedInstanceState.getString("editorialNewsState");
            mItems = savedInstanceState.getParcelableArrayList("editorialNews");
        }
...
//        Log.d("EditorialNews", "setUserVisibleHint called! " + isFragmentLoaded);
...
//    }
    ...
    public void onSaveInstanceState(Bundle state) {
        ...
        if(mItems != null) {
            state.putSerializable("editorialNewsState", "yes");
            state.putParcelableArrayList("editorialNews", new ArrayList<>(mItems));
        }
    ...
    public void updateData() {
        ...
        if(savedValue == null || mItems == null || mDoRefresh) {
            ...
            RealmResults<FavoriteNewsItem> results = realm.where(FavoriteNewsItem.class).equalTo("mCategory", "Editorial").findAll();
        ...
        mAdapter.setDefaultTag("Editorial");
        if (mDoRefresh) {
    ...
    public void loadEditorialNewsFeeds() {
